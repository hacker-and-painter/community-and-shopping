...
public class StartupLoadElasticSearch implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        this.rabbitTemplate.convertAndSend(ChengfengConstant.RabbitMQ.TOPIC_EXCHANGE,"topic.elasticsearch",ChengfengConstant.RabbitMQ.MESSAGE_ELASTICSEARCH_INIT);
